...
var selectTeamById = function(index){
	var str = 'SELECT team.id, team.name, team.created_at, team.image_name, ';
...
var insertTeam = function(titel, user, formatie, filename){
	var str = 'INSERT INTO team (name, user_id, formations_id, image_name) ';
		str+= 'VALUES ("' + titel + '",' + user + ',' + formatie + ',"' + filename + '");';
	return str;
}
...
var getQuery = {
	...
	insertTeam: function(titel, user, formatie, filename){
		return insertTeam(titel, user, formatie, filename);
	},
